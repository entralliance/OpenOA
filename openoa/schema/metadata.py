...
class SCADAMetaData(FromDictMixin):  # noqa: F821
    ...
    Args:
        ...
        WMET_HorWdDirRel (str): The measured wind direction relative to the nacelle orientation (i.e., the wind vane
            measurement), in degrees, column in the SCADA data, by default "WMET_HorWdDirRel". This data should be
            of type: `float`.
